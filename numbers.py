age = 25 # literal (type out value, actual value , value itself) 
#age = variable using the assignment operator 
print(age) #passing age as an argument
...
########## OPERATORS ##########
result = 20 / 3 #6.6666.... Float division
print(result) 

print("Here is a floor version (crop decimal):", 20 // 3) #6 Ceiling 
